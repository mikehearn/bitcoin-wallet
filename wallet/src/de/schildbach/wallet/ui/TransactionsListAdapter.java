...
public class TransactionsListAdapter extends BaseAdapter
{
	...
	public TransactionsListAdapter(final Context context, @Nonnull final WalletApplication walletApplication, final int maxConnectedPeers, final boolean showBackupWarning)
	{
